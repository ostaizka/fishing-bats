asv_count <- read.table("~/fishingbats/many_species/ASVs_counts.tsv",row.names=1)
asv_taxonomy <- read.table("~/fishingbats/many_species/ASVs_taxonomy.tsv",row.names=1)
metadata <- read.csv("~/fishingbats/many_species/samples.csv",sep=";",header=TRUE,row.names=1)
hierarchy <- read.csv("~/fishingbats/many_species/samples.csv",sep=";",header=TRUE)
...
#fish samples
sample <- read.csv("~/Lasse/Sampleinfo_pairs_merged.csv",sep=";", header=TRUE, row.names = 1)
asv <- read.csv("~/Lasse/ASVtable_phyloseq.csv", header=TRUE, row.names = 1)
taxonomy <- read.csv("~/Lasse/taxonomy_phyloseq.csv", header=TRUE, row.names = 1)
